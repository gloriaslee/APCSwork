...
public class Review {
  ...
  public static void main(String[] args){
    ...
    System.out.println(sentimentVal("abundant"));
    System.out.println(sentimentVal("acclaimed"));
    System.out.println(sentimentVal("oogawooga"));
  ...
  public static double totalSentiment(String fileName){
    String totalReview = textToString(fileName);
    String[] indWords = totalReview.split(" ");
    double reviewScore = 0;
    for(String word : indWords){
      word = removePunctuation(word);
      reviewScore += sentimentVal(word);
    }
    return reviewScore;
  }
