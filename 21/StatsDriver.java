public class StatsDriver {
  ...
  public static void main(String[]args){
    ...
    System.out.println(Stats.geoMean(-9.00,-4.00));//expected output 6.00
     ...
     System.out.println(Stats.geoMean(4,9,7));//expected output 6
    System.out.println(Stats.geoMean(0,0,0));//expected output 0
    System.out.println(Stats.geoMean(-9,4,8));//expected output error
    System.out.println(Stats.geoMean(-9,-4,-2));//expected output 6
    
    System.out.println(Stats.geoMean(4.00,9.00,2.00));//expected output 6.00
    System.out.println(Stats.geoMean(0.00,0.00,0.00));//expected output 0.00
    System.out.println(Stats.geoMean(-9.00,4.00,1.00));//expected output error
    System.out.println(Stats.geoMean(-9.00,-4.00,-9.00));//expected output 6.00
